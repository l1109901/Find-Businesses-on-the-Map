...
import ru.mail.loginregister.yol_cizimi_calisan;

/**
 * Created by gafur on 5/10/2016.
 */
public class ayrintili_arama_ve_yol extends Activity {
    ...
    private AdapterView.OnItemSelectedListener il_listener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            if (position > 0) {
                ...
                ilceArrayAdapter = new ArrayAdapter<Ilce>(ayrintili_arama_ve_yol.this, android.R.layout.simple_spinner_dropdown_item, tempIlceler);
                ilce_Spinner.setAdapter(ilceArrayAdapter);
            }
        }
    ...
    public void ara(View view){
        ...
        Intent i = new Intent(this, yol_cizimi_calisan.class);
        i.putExtra("il",il);
